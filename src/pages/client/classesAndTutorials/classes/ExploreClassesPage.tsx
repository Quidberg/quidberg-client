...
import { dummyClassList } from "../../../../components/containers/classes/BrowseAll";
import ClassCard from "../../../../components/containers/classes/ClassCard";
import { dummyPopularSubjects } from "../../../../components/containers/classes/ClassesContainer";
...
const ExploreClassesPage = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-3">
      ...
      <section>
        <div className="flex items-center gap-1">
          <p className="md:text-lg">Recommended Classes</p>
          <Button
            className="text-main_bg hover:underline "
            variant={"plain"}
          >
