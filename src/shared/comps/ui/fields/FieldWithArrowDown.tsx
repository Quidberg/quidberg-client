...
import { DropDownFieldType } from "../../../types/FieldTypes";
import { DropListType } from "../../../types/RegistrationDataTypes";
import { useListenForOutsideClicks } from "../../../hooks/listenForOutsideClicks";
import WarningText from "../info/WarningText";
import InfoButton from "../buttons/InfoButton";
import InfoModal from "../../../../app/client/containers/modals/infoModal/InfoModal";
              ...
              <button
                ...
                className={cn(
                  `   relative flex w-full items-center text-start justify-between  ${
                    ...
                    error
                      ? "border-warning_red ahashakeheartache"
                      : ""
                  }
