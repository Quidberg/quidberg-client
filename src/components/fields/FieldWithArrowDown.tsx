    ...
    return (
      <div className=" relative w-full flex flex-col justify-between items-center">
        ...
        <div className="w-full ">
          {title && (
            <header>
              <InfoButton textClassName={` ${titleClassName ? titleClassName :"font-semibold"}`} onClick={handleInfoButton}>{title}</InfoButton>
            </header>
          )}
          ...
          <section className="relative w-full" ref={dropdownRef}>
            ...
            <div className="flex flex-col gap-2">
              <button
                type="button"
                className={`${(isDropDownLocked || isIdle) && 'cursor-text'}   relative flex w-full items-center text-start justify-between  ${
              ...
              {typeof error !== 'string' ? error?.map(error=>(
