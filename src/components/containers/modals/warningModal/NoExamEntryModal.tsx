    ...
    <Modal isOpen={isOpen} close={close}>
      <div className="flex flex-col items-center justify-center p-3 py-4 md:p-8 gap-7">
        ...
        <section className="mt-8 text-center flex flex-col gap-4 ">
          <button
            className="font-semibold text-[18px] md:text-lg text-main_bg hover:text-main_bg/70"
            onClick={handleSelectExam}
          >
            Selecting your Examination results will improve your analysis.
          </button>
          <p className="">
            Do you want to proceed without adding Examination results?
          </p>
        </section>
