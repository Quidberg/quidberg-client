      ...
      <main className="ml-4">
        <div>
          {!unmetRequirements.length ? (
            <p>
              You have the{" "}
              <span className="text-main font-semibold">{" minimum "}</span>{" "}
            ...
            <div className="flex gap-2">
              <p className="text-main_font/60">
                ...
                <span className="font-bold text-red-500">{" not "}</span> met:
              </p>
            ...
            {table.getHeaderGroups().map((headerGroup) => (
              ...
              >
                {headerGroup.headers.map((header) => (
                  <th key={header.id} className="text-light_font py-2">
...
export const PassedRequirement = ({ passed }: { passed: boolean }) => {
  return (
    <span
