...
const SchoolRegistration = () => {
  ...
  // STATES
  const [formValState, setFormValState] =
    useState<RegFormValues>(formValues);
  const [formItemsState, setFormItemsState] = useState<{
    [index: string]: DropDownFieldDataType;
  }>(formItems);
  const [errors, setErrors] =
    useState<SchoolRegFormErrors>(initialErrors);
  ...
  return (
    <div className="w-full max-w-[700px] flex flex-col items-center gap-4 sm:gap-6">
      <h1 className="text-center text-lg font-main_header_weight text-light_font">
        Our <span className="text-main_bg ">Oracle</span> feature
        provides detailed analysis on your chances of admission into
        your choice school{" "}
      </h1>
