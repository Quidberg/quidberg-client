import { classConverter } from "../../../../../shared/utils/utilFunction";
  ...
  return (
    <div className="text-sm md:text-[0.9rem]">
      <section className="w-fit">
        <table className="border-spacing-x-4 border-spacing-y-3 table-auto border-separate -ml-4">
          <tbody className="">
            <tr className="">
            ...
            <tr className="hidden sm:grid">
              <td className="text-light_font flex flex-1 w-fit whitespace-nowrap">
                {" "}
                <p className="">{`Academic Goal`}</p>
              </td>
              <td className="py-1 px-2 bg-light_border_color rounded-md font-medium">
                {" "}
